...
(function(){
	...
	let link = document.createElement("link");
		...
		rt_aside.innerHTML = `<div class="conceal-con">
	...
	let concealCon = document.querySelector(".conceal-con");
	let concealCover = document.querySelector(".conceal-cover");
    sr_btn.onclick = function(e){
		e.preventDefault();
		contact_form.classList.add("active");
		close_btn.style.display = "block";
		contact_form.setAttribute("style",`transition:all .5s linear`);
		concealCover.setAttribute("style",`opacity:1;z-index:1`);
		concealCon.setAttribute("style",`z-index:888`);
	}
	close_btn.onclick = function(e){
		...
		concealCover.setAttribute("style",`opacity:0`);
	}
	concealCover.onclick = function (e) {
		e.preventDefault();
		contact_form.classList.remove("active");
		close_btn.style.display = "none";
		contact_form.setAttribute("style",`transform:translateX(400px);transition:all .8s linear`);
		concealCover.setAttribute("style",`opacity:0;z-index:-9999`);
	}
