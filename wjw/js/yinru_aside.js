(function(){
	...
	yinru_aside.innerHTML=`<div class="aside_one">
			<div class="aside_one_arvin">
				<h2>MENU</h2>
				<p><img src="imageLogo/line.jpg" alt=""></p>
				<ul>
					...
					<li><a href="../html/service-and-price.html">SERVICES AND PRICES</a></li>
					...
					<li><a href="../html/Construction consulting.html">ARVHITECTURAL CONSULTATION</a></li>
				</ul> 
			</div>
			<div class="close">
				<p></p>
