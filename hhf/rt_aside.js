(function(){
	...
	<div class="row">
	<input placeholder="YOUR NAME" name="name" id="name" type="text" maxlength="100" />
	</div>
	<div class="row">
	<input placeholder="YOUR PHONE" name="phone" id="phone" type="text" />
	</div>
	<div class="row">
	...
	<input name="" id="yzmvalue" type="text" />
	</div>
	<div class="row">
...
　　　　var res = ajax.responseText;
  ...
  　　}
	...
	ajax.open('get','http://127.0.0.1/demo/demo-bak/hhf/php/project.php?name='+name+'&phone='+phone+'&options='+options);
	//步骤三:发送请求
	ajax.send();
